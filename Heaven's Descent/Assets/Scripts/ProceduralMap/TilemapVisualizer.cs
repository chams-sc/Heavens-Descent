...
public class TilemapVisualizer : MonoBehaviour
{
    ...
    [SerializeField]
    private TileBase[] floorTiles; // Array to hold the floor tiles
    ...
    public void PaintFloorTiles(IEnumerable<Vector2Int> floorPositions)
    {
        ...
        {
            TileBase randomTile = GetRandomFloorTile();
    ...
    {
        int randomIndex = UnityEngine.Random.Range(0, floorTiles.Length);
